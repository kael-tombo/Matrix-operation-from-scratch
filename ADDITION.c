...
void  addition()
{
    ...
    */
    ...
    printf("\t <>Veuillez enter les lignes et colones des matrices a additionner:\n");
    printf("\n\n");
    do
    {
    ...
    printf("\n\n");
    printf("\t>> ET LE RESULTAT DE L'ADDITION DE CES DEUX MATRICES EST :\n ");
    printf("\n\n");
       for (i=0;i<=nb_ligne-1;i++)
       {
                  for (j=0;j<=nb_colone-1;j++)
