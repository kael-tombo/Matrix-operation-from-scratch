...
void transpose()
{
    ...
    */
    ...
    printf("\t saisissez les lignes et colonnes  de la matrice :\n");
    printf("\n\n");
    float l,c;
    do
    {
    ...
    nb_ligne=(int)l;
    nb_colone=(int)c;
    float tab[nb_ligne][nb_colone];
    float tab_transpos[nb_colone][nb_ligne];
    printf("\n\n");
 ...
 printf ("\t <> la transpose de cette matrice est :\n");
 printf("\n\n");
   for (i=0;i<nb_ligne;i++)
    {
        for(j=0;j<nb_colone;j++)
        {
            tab_transpos[j][i]=tab[i][j];
        }
    }
