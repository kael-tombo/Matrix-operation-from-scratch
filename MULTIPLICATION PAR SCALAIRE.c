...
void mult_par_scalaire ()
{
    ...
    */
    ...
    float scalaire;
    printf("\t <> Veuillez entrer les caracteristiques de la matrice: \n");
    printf("\n\n");
    float l,c;
    do
    {
        printf("\t>veuillez enter le nombre de ligne:");
        scanf("%f",&l);
        printf("\n");
        printf("\t>veuillez enter le nombre de colonne:");
        scanf("%f",&c);
        printf("\n");
    ...
    printf("\n");
    printf("\t <> Entrer le nombre que vous voulez multiplier avec la matrice :");
    scanf("%f",&scalaire);
    printf("\n");
    ...
    for(i=0;i<nb_ligne;i++)
    {
        for(j=0;j<nb_colone;j++)
        {
            resultat[i][j]=scalaire*M[i][j];
        }
    }
    printf("\t Et le resultat de la multiplication de cette matrice par le scalaire %f est:",scalaire);
    printf("\n\n");
    for (i=0;i<nb_ligne;i++)
    {
        for(j=0;j<nb_colone;j++)
        {
            printf("\t%.1f",resultat[i][j]);
        }
        printf("\n\n");
    }
   printf("\n\n\n\n");
